...
require 'PHPMailer/PHPMailer/SMTP.php';
 ...
 try {                      
     ...
     $mail->SMTPAuth   = true;                                   
     $mail->Username   = 'burhanmehmood3395@gmail.com';                
     $mail->Password   = 'jxlg lgng tbaj fbqe';                               
     $mail->SMTPSecure = PHPMailer::ENCRYPTION_SMTPS;          
     $mail->Port       = 465;                                    
     $mail->setFrom('arslannaqi66@gmail.com', 'burhan');
     $mail->addAddress('burhanmehmood3395@gmail.com', 'admin');        
     $mail->isHTML(true);                                  
